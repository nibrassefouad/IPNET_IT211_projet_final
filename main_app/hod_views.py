...
def add_staff(request):
    ...
    context = {'form': form, 'page_title': 'Ajouter enseignant'}
...
def add_student(request):
    ...
    context = {'form': student_form, 'page_title': 'Ajouter étudiant'}
    if request.method == 'POST':
...
def add_session(request):
    ...
    context = {'form': form, 'page_title': 'Ajouter session'}
    if request.method == 'POST':
        if form.is_valid():
            try:
                form.save()
...
def manage_session(request):
    ...
    context = {'sessions': sessions, 'page_title': 'Voir sessions'}
